  ...
  <q-page class="flex flex-center">
    ...
    <q-card>
        <q-card-section style="padding:20px; padding-right:20px;background-color:#f95f5f;" > 
            <h4 style="text-align:center;color:white">Fill In The Details<br>of Tour Package</h4>
        </q-card-section>
            <q-form
            @reset="onReset"
            class="q-gutter-md"
    ...
    <q-card-section>
      <div>
        <q-btn label="Submit" type="submit" color="red"  @click="onSubmit()" to="/tourEdit"/>
