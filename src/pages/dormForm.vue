  ...
  <q-page class="flex flex-center">
    ...
    <q-card>
        <q-card-section style="padding:20px; padding-right:20px;background-color:#f95f5f;" > 
            <h4 style="text-align:center;color:white">Fill In The Details<br> of Dormitory Package </h4>
        </q-card-section>
            <q-form
            @submit="onSubmit"
            @reset="onReset"
    ...
    <q-card-section>
      <div>
        <q-btn label="Submit" type="submit" color="red" to="/dormEdit" @click="onSubmit()"/>
